<template>
    <v-card variant="text">
        <v-tabs v-model="tab" align-tabs="center">
            <v-tab value="tab-1">天地玄黄</v-tab>
            <v-tab value="tab-2">宇宙洪荒</v-tab>
            <v-tab value="tab-3">日月盈昃</v-tab>
            <v-tab value="tab-4">辰宿列张</v-tab>
        </v-tabs>
        <v-tabs-window v-model="tab">
            <v-tabs-window-item v-for="i in 4" :key="i" :value="'tab-' + i">
                <v-card class="px-4 py-4">
                    <v-card-text class="text-h5 text-uppercas text-uppercasefont-weight-black px-4">
                        {{ text }}
                    </v-card-text>
                </v-card>
            </v-tabs-window-item>
    ...
    <hr />
    <div class="px-8 py-4 text-h6">
        《千字文》為南朝梁周興嗣所撰，內容涵蓋自然、人文、道德等典故，是古代蒙學重要教材。若需進一步解讀或背景說明，可隨時提出！
    </div>
</template>
<script setup>
import { ref } from 'vue'
